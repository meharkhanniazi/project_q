...
void reset_score_c2();
void disp_record_c2();
void score_write_b1(int score, char[]);
void disp_record_b1();
void reset_score_b1();
 ...
 for( i=0; i<userquiz; i++)
 {
  ...
  break;
	...
	switch(i)
	{
		...
		{
			printf("\nAnswer Not Correct.");
			printf("\nCorrect Answer is \"Sir Agha Khan\".");
			getch();
			clrscr();
		}
		break;
		...
		{
			printf("\nAnswer Not Correct.");
			printf("\nCorrect Answer is \"Khunjerab Pass\".");
			getch();
			clrscr();
		}
		break;
		...
		{
			printf("\nAnswer Not Correct.");
			printf("\nCorrect Answer is \"Manchar Lake\".");
			getch();
			clrscr();
		}
		break;
		...
		{
			printf("\nAnswer Not Correct.");
			printf("\nCorrect Answer is \"Mound of the Dead\".");
			getch();
			clrscr();
		}
		break;
		...
		{
			printf("\nAnswer Not Correct.");
			printf("\nCorrect Answer is \"Parlimentary\".");
			getch();
			clrscr();
		}
		break;
